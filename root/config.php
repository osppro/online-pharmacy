...
switch(DB_URL){
	case 'localhost':
		...
		defined ("DB_NAME") or define("DB_NAME", "online_pharmacy");
		defined ("SITE_URL") or define("SITE_URL", 'http://localhost/online-pharmacy');
		defined ("HOME_URL") or define("HOME_URL", 'http://localhost/online-pharmacy/home');
	break;
